...
// Apply renderer to all columns
            ...
            public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
                ...
                switch (value.toString()) {
                    case "Active":
                        ...
                        break;
                    case "Pending":
                        label.setBackground(new Color(255, 244, 204)); // Light Orange
        ...
        usersTable.getColumnModel().getColumn(5).setCellRenderer(new StatusRenderer()); // Assuming "Status" is column index 5
